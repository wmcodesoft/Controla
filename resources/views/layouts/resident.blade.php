    ...
    <div class="min-h-full flex flex-col">
        ...
        <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-8 flex-1">
            ...
            <nav class="flex gap-6 mb-8 text-sm border-b border-slate-800 pb-3">
                ...
                <a href="{{ route('resident.pre-authorizations.index') }}" class="{{ request()->routeIs('resident.pre-authorizations.*') ? 'text-teal-400 border-b-2 border-teal-400' : 'text-slate-400 hover:text-white' }} pb-3 -mb-3">Autorizaciones</a>
