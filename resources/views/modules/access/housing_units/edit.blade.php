<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Editar Apartamento / Casa</h2>
    </x-slot>
    <div class="py-6">
                ...
                <form method="POST" action="{{ route('access.housing_units.update', $housingUnit) }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="unit_number" value="{{ old('unit_number', $housingUnit->unit_number) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="floor" value="{{ old('floor', $housingUnit->floor) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                        <div>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="notes" rows="2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('notes', $housingUnit->notes) }}</textarea>
                    </div>
