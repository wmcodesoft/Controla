                ...
                <div x-data="entryFlow()">
                    ...
                    <div class="flex gap-3">
                        <label class="relative flex-1 cursor-pointer">
                            <input type="radio" x-model="accessType" value="visitor" class="sr-only peer">
                        ...
                        <label class="relative flex-1 cursor-pointer">
                            <input type="radio" x-model="accessType" value="visitor_vehicle" class="sr-only peer">
                    ...
                    <form method="POST" action="{{ route('access.logs.entry.store') }}">
                        @csrf
                        <input type="hidden" name="access_type" x-model="accessType">
                        ...
                        <div class="bg-slate-800 rounded-xl p-4 mb-6">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" x-model="documentNumber" @input.debounce.500ms="lookupDocument()" placeholder="Ingrese o escanee el documento..." class="block w-full pl-10 rounded-lg bg-slate-950 border-slate-700 text-white focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span x-show="autoCreated" class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold bg-amber-800 text-amber-200">Auto</span>
                                            </div>
                        ...
                        <div x-show="accessType === 'visitor_vehicle' && personType === 'visitor'" x-transition class="bg-cyan-900/30 rounded-xl p-4 mb-6 border border-cyan-800">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" x-model="vehiclePlate" @input.debounce.500ms="lookupVehicle()" placeholder="ABC 123" class="block w-full rounded-lg bg-slate-950 border-slate-700 text-white uppercase focus:border-cyan-500 focus:ring-cyan-500" required>
                                </div>
                                <div>
                            ...
                            <div x-show="vehicleId" class="mt-2 text-xs text-emerald-400">✓ Vehículo encontrado y seleccionado</div>
                        </div>
                ...
                async lookupDocument() {
                    ...
                    try {
                        ...
                        if (data.found) {
                            ...
                            this.autoCreated = data.auto_created || false;

                            if (this.personType === 'resident') {
                                this.accessType = 'resident';
                            } else {
                                this.accessType = 'visitor';
                            }
                        } else {
                            this.clearPerson();
                        }
