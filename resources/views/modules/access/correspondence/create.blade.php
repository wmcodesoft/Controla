        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100">
                    <h3 class="text-lg font-semibold text-gray-900">Nuevo Paquete o Encomienda</h3>
                    <p class="text-sm text-gray-500 mt-0.5">Registre la correspondencia recibida para su posterior entrega</p>
                </div>
                <div class="px-6 py-5">
                    <div x-data="{ assignType: 'resident' }">
                        <label class="block text-sm font-semibold text-gray-700 mb-3">Asignar a</label>
                        <div class="flex flex-wrap gap-2 mb-6">
                            <label class="relative cursor-pointer">
                                <input type="radio" x-model="assignType" value="resident" class="sr-only peer">
                                <div class="px-4 py-2 border-2 rounded-lg text-sm font-medium transition-all peer-checked:border-pink-500 peer-checked:bg-pink-50 peer-checked:text-pink-700 border-gray-200 bg-white text-gray-700 hover:border-gray-300">
                                    Residente
                                </div>
                            </label>
                            <label class="relative cursor-pointer">
                        ...
                        <form method="POST" action="{{ route('access.correspondence.store') }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div x-show="assignType === 'resident'">
                                    ...
                                    <select name="resident_id" class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div x-show="assignType === 'host'">
                                    ...
                                    <select name="host_id" class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        <option value="">Seleccionar...</option>
                                ...
                                <div>
                                    ...
                                    <select name="package_type" class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="carrier" value="{{ old('carrier') }}" class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Ej: Servientrega, Envía, etc.">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Guía</label>
                                    <input type="text" name="courier_guide" value="{{ old('courier_guide') }}" class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Número de guía">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Visitante (quien dejó)</label>
                                    <select name="visitor_id" class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div class="mt-4">
                                ...
                                <textarea name="notes" rows="2" class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Observaciones adicionales...">{{ old('notes') }}</textarea>
                            </div>
                            <div class="mt-6 flex justify-end gap-3 pt-4 border-t border-gray-100">
                                <a href="{{ route('access.correspondence.index') }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-200 rounded-lg font-semibold text-xs text-gray-700 hover:bg-gray-50 transition-colors">Cancelar</a>
