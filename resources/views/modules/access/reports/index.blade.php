        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                    <h3 class="text-sm font-semibold text-gray-900 mb-1">Accesos diarios (14 días)</h3>
                    <p class="text-xs text-gray-500 mb-4">Tendencia de ingresos</p>
                    <canvas id="reportDailyChart" height="180"></canvas>
                </div>
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                    <h3 class="text-sm font-semibold text-gray-900 mb-1">Distribución por tipo</h3>
                    <p class="text-xs text-gray-500 mb-4">Visitantes vs vehiculares vs residentes</p>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 lg:col-span-2">
                    <h3 class="text-sm font-semibold text-gray-900 mb-1">Top ubicaciones</h3>
                    <p class="text-xs text-gray-500 mb-4">Las 5 ubicaciones con más actividad</p>
            ...
            <div class="mt-8 bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <form method="GET" class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
                    <div>
                        ...
                        <input type="date" name="date_from" value="{{ request('date_from') }}" class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600">Hasta</label>
                        <input type="date" name="date_to" value="{{ request('date_to') }}" class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600">Estado</label>
                        <select name="status" class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <select name="access_type" class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            <option value="">Todos</option>
                    ...
                    <div>
                        ...
                        <select name="location_id" class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            ...
            <div class="mt-8 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                    <div>
                        <h3 class="text-sm font-semibold text-gray-900">Registros de Acceso</h3>
                        <p class="text-xs text-gray-500 mt-0.5">Detalle de los movimientos filtrados</p>
                    </div>
                    <span class="text-xs text-gray-400">{{ $logs->total() }} registros</span>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-100">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Anfitrión</th>
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            @empty
                            <tr><td colspan="7" class="px-6 py-12 text-center text-sm text-gray-500">Sin resultados</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
